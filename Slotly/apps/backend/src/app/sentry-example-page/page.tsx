    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://slotlyltd.sentry.io/issues/?project=4509682864291920">Issues Page</a>.
